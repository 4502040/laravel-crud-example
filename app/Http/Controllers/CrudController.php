...
abstract class CrudController extends Controller
{
    ...
    // abstract public static function setModelClass();
    ...
    public function show($id)
    {
        ...
        return view(sprintf('%s.show', $this->setViewPath()), compact('model'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(sprintf('%s.edit', $this->setViewPath()), compact('model'));
    }
    ...
    public function delete($id)
    {
        $this->checkForDisabled(__FUNCTION__);
        $model = $this->setModel()->find($id);
        return view(sprintf('%s.delete', $this->setViewPath()), compact('model'));
    }
